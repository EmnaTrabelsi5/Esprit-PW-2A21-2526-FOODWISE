      ...
      <div class="fw-card__body">
        <form class="fw-form" method="post" action="<?= htmlspecialchars($routesModule2['front_inscription'] ?? '', ENT_QUOTES, 'UTF-8') ?>" novalidate>
          ...
          <div class="fw-form__group">
            ...
            <input type="text" id="fw-ins-nom" name="nom" value="<?= htmlspecialchars((string) ($old['nom'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" required autocomplete="family-name">
          ...
          <div class="fw-form__group">
            ...
            <input type="email" id="fw-ins-email" name="email" value="<?= htmlspecialchars((string) ($old['email'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" required autocomplete="email">
          ...
          <div class="fw-form__group">
            ...
            <input type="password" id="fw-ins-pass" name="password" required autocomplete="new-password">
          ...
          <div class="fw-form__group">
            ...
            <input type="password" id="fw-ins-pass2" name="password_confirm" required autocomplete="new-password">
          </div>
