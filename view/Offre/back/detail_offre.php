...
<div class="search-bar">
  <form method="GET" action="/FOODWISE/index.php?route=admin/offres/indexAdmin">
...
<form method="POST" action="/FOODWISE/index.php?route=admin/offres/delete" style="display:inline">
...
<p><?= $criticalCount ?> offre(s) en stock critique ⚠</p>
    ...
    <section class="dashboard-card dashboard-card--secondary">
      ...
      <div class="card-body">
        <a href="/FOODWISE/index.php?route=admin/offres/create" class="button button--success" style="width:100%; margin-bottom:12px;">Ajouter une offre</a>
        <a href="/FOODWISE/index.php?route=admin/offres/indexAdmin" class="button button--secondary" style="width:100%;">Voir toutes les offres</a>
      </div>
    </section>
    <section class="dashboard-card dashboard-card--secondary">
      <div class="card-header">
