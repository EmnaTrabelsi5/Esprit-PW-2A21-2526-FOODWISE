...
<div class="page-header-bar">
  ...
  <a href="?route=admin/offres/indexAdmin" class="btn btn-outline">← Retour aux offres</a>
</div>
...
<div style="max-width:780px">
  <div class="card">
    ...
    <form method="post"
          action="<?= $isEdit 
    ? '?route=admin/offres/update' 
    : '?route=admin/offres/store' ?>"
          novalidate>
      ...
      <div style="display:flex;gap:12px">
        ...
        <a href="?route=admin/offres/indexAdmin" class="btn btn-outline">Annuler</a>
      </div>
    </form>
  </div>
</div>
