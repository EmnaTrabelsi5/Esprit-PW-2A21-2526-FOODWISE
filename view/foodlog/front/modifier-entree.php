...
if ($id <= 0) {
    header('Location: /FOODWISE/?route=foodlog/journal');
    exit;
}
...
<section class="card">
  ...
  <form id="entry-form" action="/FOODWISE/?route=foodlog/modifier-entree&id=<?= (int) $entry['id'] ?>" method="post">
    ...
    <div class="flex-between mt-1 mb-0">
      ...
      <div style="display:flex;gap:8px;">
        <a href="/FOODWISE/?route=foodlog/supprimer&id=<?= (int) $entry['id'] ?>&source=front"
