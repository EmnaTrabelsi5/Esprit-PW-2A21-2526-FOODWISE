...
<head>
  ...
  <link rel="stylesheet" href="assets/foodwise.css">
...
<aside class="sidebar">
  <div class="sidebar-logo">
   <img src="assets/img/logo.png" alt="FoodWise Logo">
  </div>
  ...
  <nav class="sidebar-nav">
    <?php if ($backoffice): ?>
      ...
      <a href="?route=foodlog/admin/suivi" class="nav-item <?= $activeNav === 'foodlog_suivi_admin' ? 'active' : '' ?>">
