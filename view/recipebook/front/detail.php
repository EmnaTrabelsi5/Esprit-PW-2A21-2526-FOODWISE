...
<nav style="font-size:13px;color:var(--texte-leger);margin-bottom:16px;">
  <a href="/recettes" style="color:var(--brun-chaud);text-decoration:none;">Mes Recettes</a>
...
<div style="display:grid; grid-template-columns: 1fr 340px; gap:28px; align-items:start;">
      ...
      <div style="padding:24px;">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;flex-wrap:wrap;">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <a href="/recettes/<?= $recette->id_recette ?>/modifier" class="btn btn-outline btn-sm">✏️ Modifier</a>
            <form method="POST" action="/recettes/<?= $recette->id_recette ?>/supprimer"
      ...
      <ul style="list-style:none;display:flex;flex-direction:column;gap:10px;">
        ...
        <li style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:var(--creme);border-radius:8px;">
          <div style="display:flex;align-items:center;gap:10px;">
            ...
            <div>
              <div style="font-weight:700;font-size:14px;color:var(--texte-sombre);">
                <?= htmlspecialchars($ri->ingredient->nom) ?>
              </div>
          ...
          <div style="text-align:right;">
            ...
            <?php if ($ri->ingredient->est_allergene || !$ri->ingredient->est_disponible): ?>
              <div style="font-size:11px;color:var(--alerte-orange);">
                <?= $ri->ingredient->est_allergene ? '⚠️ Allergène' : '❌ Indisponible' ?>
              </div>
            <?php endif; ?>
          </div>
        </li>
  ...
  <div>
    ...
    <!-- Actions -->
    <div class="card">
      <a href="/planificateur/ajouter?recette=<?= $recette->id_recette ?>" class="btn btn-secondary" style="width:100%;justify-content:center;margin-bottom:10px;">
        📅 Ajouter au planificateur
      </a>
      <a href="/favoris/ajouter?recette=<?= $recette->id_recette ?>" class="btn btn-outline" style="width:100%;justify-content:center;">
