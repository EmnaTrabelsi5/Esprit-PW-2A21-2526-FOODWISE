...
<nav style="font-size:13px;color:var(--texte-leger);margin-bottom:16px;">
    <a href="/FOODWISE/?route=recettes" style="color:var(--brun-chaud);text-decoration:none;">Mes Recettes</a>
    <span style="margin:0 6px;">›</span>
    <a href="/FOODWISE/?route=recettes/<?= $recette->id_recette ?>"
...
<div style="display:grid;grid-template-columns:1fr 380px;gap:24px;align-items:start;">
  ...
  <div>
        ...
        <?php if (!empty($avecOffre)): ?>
            ...
            <div class="offre-row">
                ...
                <div style="display:flex;flex-direction:column;align-items:flex-end;gap:6px;">
                    ...
                    <a href="/FOODWISE/?route=offres&action=show&id=<?= $ligne->offre_id ?>"
    ...
    <div style="display:flex;justify-content:flex-end;margin-top:20px;">
        <a href="/FOODWISE/?route=commandes&action=createBulk&id_recette=<?= $recette->id_recette ?>" 
