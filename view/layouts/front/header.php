...
<div class="main-content">
  <header class="topbar">
    ...
    <nav class="topbar-nav">
      <a href="/FOODWISE/?route=recettes" class="<?= $activeNav === 'recettes' ? 'active' : '' ?>">Mes Recettes</a>
    ...
    <a class="topbar-user" href="/FOODWISE/?route=module2/front/mon_profil" style="text-decoration:none;">
