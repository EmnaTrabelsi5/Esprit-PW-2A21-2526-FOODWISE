...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars(assetUrl('localmarket.css'), ENT_QUOTES, 'UTF-8') ?>">
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    <?php if ($backoffice): ?>
      <a href="?route=admin" class="nav-item <?= $activeNav === 'dashboard' ? 'active' : '' ?>">
      ...
      <a href="?route=admin_recettes" class="nav-item <?= $activeNav === 'gestion_recettes' ? 'active' : '' ?>">
      ...
      <a href="?route=admin_ingredients" class="nav-item <?= $activeNav === 'gestion_ingredients' ? 'active' : '' ?>">
      ...
      <a href="?route=admin/offres" class="nav-item <?= $activeNav === 'partenaires' ? 'active' : '' ?>">
      ...
      <a href="?route=community/admin" class="nav-item <?= $activeNav === 'community' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
        Avis Communauté
      </a>
      <a href="?route=module2.back.dashboard.profils" class="nav-item <?= $activeNav === 'utilisateurs' ? 'active' : '' ?>">
      ...
      <!-- ── MealPlanner Admin ── -->
      <p style="padding:12px 18px 4px;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:rgba(255,255,255,.4);margin:0;">MealPlanner</p>
      <a href="?route=mealplanner/back/home/index" class="nav-item <?= $activeNav === 'mealplanner_admin' ? 'active' : '' ?>">
      ...
      <a href="?route=foodlog/admin/dashboard" class="nav-item <?= $activeNav === 'foodlog_admin' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M18 20V10M12 20V4M6 20v-6"/></svg>
        Dashboard FoodLog
      </a>
      <a href="?route=foodlog/admin/entries" class="nav-item <?= $activeNav === 'foodlog_entries' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
        Entrées Alimentaires
      </a>
      <a href="?route=foodlog/admin/suivi" class="nav-item <?= $activeNav === 'foodlog_suivi' ? 'active' : '' ?>">
