  ...
  <div style="display: grid; grid-template-columns: 0.6fr 1.8fr 0.6fr; gap: 1rem;">
    ...
    <div>
      ...
      <section class="fw-card" aria-labelledby="fw-actions-title" style="padding: 0; margin-top: 0.75rem;">
        ...
        <div class="fw-card__body" style="padding: 0.5rem 0.75rem;">
          <a href="/FOODWISE/?route=favoris" class="fw-btn fw-btn--red" style="width: 100%; text-align: center; display: inline-block; background-color: #e74c3c; color: white; text-decoration: none; padding: 0.5rem 1rem; border-radius: 4px; font-size: 0.8rem;">
