...
const STATS_API_URL = '/FOODWISE/index.php?route=community/api/stats';
        ...
        html += `
            <div class="review-card">
                ...
                <div class="review-meta">
                    ...
                    <span>👤 ${escapeHtml(a.username || ('Utilisateur ' + (a.user_id || 1)))}</span>
                </div>
                    ...
                    html += `
                        <div class="response-card">
                            <div class="response-header">
                                <span class="response-author">💬 ${escapeHtml(r.username || ('Utilisateur ' + r.user_id))}</span>
...
function editReview(id) {
    ...
    if (document.getElementById('editUserName')) {
        document.getElementById('editUserName').value = review.username || ('Utilisateur ' + (review.user_id || 1));
    }
...
function editReponse(id) {
    ...
    if (document.getElementById('editReponseReviewId')) {
        document.getElementById('editReponseReviewId').value = 'Avis #' + reponse.review_id;
    }
    if (document.getElementById('editReponseAuthor')) {
        document.getElementById('editReponseAuthor').value = reponse.username || ('Utilisateur ' + reponse.user_id);
    }
