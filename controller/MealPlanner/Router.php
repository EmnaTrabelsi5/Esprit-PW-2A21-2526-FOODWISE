...
final class Router
{
    public function dispatch(): void
    {
        ...
        $map = [
            ...
            'magic_recipe' => [
                'front' => [\Controller\Front\MagicRecipeController::class, $this->resolveCrudAction($action)],
            ],
            'digital_twin' => [
                'front' => [\Controller\Front\DigitalTwinController::class, 'index'],
            ],
            'wallet' => [
                'front' => [\Controller\Front\CreditController::class, 'index'],
            ],
        ];
    ...
    {
        $allowed = ['index', 'show', 'create', 'store', 'edit', 'update', 'destroy', 'import'];
