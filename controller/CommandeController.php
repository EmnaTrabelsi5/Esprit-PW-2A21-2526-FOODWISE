...
class CommandeController {
    ...
    private function storeBulk(): void {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: /FOODWISE/index.php?route=commandes/index');
            exit;
        }
    ...
    if (!empty($errors)) {
        $_SESSION['flash_error'] = implode('<br>', $errors);
        header("Location: /FOODWISE/index.php?route=commandes/create&id_offre={$id_offre}");
        exit;
    }
    ...
    private function update(): void {
        ...
        if (!empty($errors)) {
            $_SESSION['flash_error'] = implode('<br>', $errors);
            header("Location: /FOODWISE/index.php?route=commandes/edit&id={$id_commande}");
            exit;
        }
