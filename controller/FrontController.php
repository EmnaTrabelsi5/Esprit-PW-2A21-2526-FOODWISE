...
class FrontController
{
    ...
    public function monProfil(): void
    {
        ...
        require __DIR__ . '/../view/utilisateur/front/mon_profil.php';
    }
    ...
    public function profilEdit(): void
    {
        ...
        require __DIR__ . '/../view/utilisateur/front/profil_edit.php';
    }
            ...
            if (empty($errors)) {
                ...
                if (empty($errors)) {
                    ...
                    if ($user === null) {
                        ...
                        redirect(buildRoute('recettes'));
                    }
                }
            }
        }

        require __DIR__ . '/../view/utilisateur/front/connexion.php';
    }
    ...
    public function inscription(): void
    {
        ...
        require __DIR__ . '/../view/utilisateur/front/inscription.php';
    }
    ...
    public function passwordReset(): void
    {
        ...
        require __DIR__ . '/../view/utilisateur/front/mot_de_passe_oublie.php';
    }
    ...
    public function verifyResetCode(): void
    {
        ...
        require __DIR__ . '/../view/utilisateur/front/verify_reset_code.php';
    }
    ...
    public function allergiesRegimes(): void
    {
        ...
        $profilNutritionnel = $old;
        $utilisateur = $user;
        require __DIR__ . '/../view/utilisateur/front/allergies_regimes.php';
    }
    ...
    public function viewPublicProfile(): void
    {
        ...
        $activeNav = 'messages';
        $currentUser = $user;
        require __DIR__ . '/../view/utilisateur/front/public_view.php';
    }
