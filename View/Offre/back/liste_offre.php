...
<div class="card">
  ...
  <div class="card__body">
    ...
    <!-- ✅ ADD BUTTON HERE -->
    <a href="/FOODWISE1/router/offreRouter.php?action=create" class="btn btn--primary add-btn">
      ➕ Ajouter une offre
    </a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="table-actions">
            <a href="/FOODWISE1/router/offreRouter.php?action=show&id=<?= $offre['id'] ?>" class="btn btn--secondary btn-sm" title="Voir les détails">👁</a>
            <a href="/FOODWISE1/router/offreRouter.php?action=edit&id=<?= $offre['id'] ?>" class="btn btn--primary btn-sm" title="Modifier">✏️</a>
