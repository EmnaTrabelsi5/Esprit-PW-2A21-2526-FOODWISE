    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Mes commandes</h2>
                <a href="offre.php?action=index" class="btn btn-primary">Voir les offres</a>
            </div>
                                    ...
                                    <?php if ($commande['statut'] === 'en_attente'): ?>
                                        <div class="d-grid gap-2">
                                            <?php if ($commande['paiement_status'] === 'non_paye'): ?>
                                                <a href="commande.php?action=pay&id=<?= $commande['id_commande'] ?>"
                                                   class="btn btn-success btn-sm">💳 Payer</a>
                                            <?php endif; ?>
                                            <a href="commande.php?action=cancel&id=<?= $commande['id_commande'] ?>"
