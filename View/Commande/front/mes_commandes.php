...
<?php require_once __DIR__ . '/../../../Model/CommandeModel.php'; ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Mes commandes</h2>
                <a href="/FOODWISE1/router/offreRouter.php?action=index" class="btn btn-primary">Voir les offres</a>
            </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="card h-100">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><?= $commande['offre_nom'] ?? 'Offre inconnue' ?></h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-2">
                                ...
                                <div class="card-footer">
                                    <?php if ($commande['statut'] === 'en_attente'): ?>
                                        <div class="d-grid gap-2">
                                            <a href="/FOODWISE1/router/commandeRouter.php?action=edit&id=<?= $commande['id_commande'] ?>"
                                               class="btn btn-warning btn-sm">✏️ Modifier</a>
                                            <?php if ($commande['paiement_status'] === 'non_paye'): ?>
                                                <a href="/FOODWISE1/router/commandeRouter.php?action=pay&id=<?= $commande['id_commande'] ?>"
                                                   class="btn btn-success btn-sm">💳 Payer</a>
                                            <?php endif; ?>
                                            <a href="/FOODWISE1/router/commandeRouter.php?action=cancel&id=<?= $commande['id_commande'] ?>"
...
<td>
    <div>
        Sous-total: <?= number_format($prix['subtotal'], 2) ?> TND<br>
        Taxe: <?= number_format($prix['taxe'], 2) ?> TND<br>
        Livraison: <?= number_format($prix['livraison'], 2) ?> TND<br>
        <strong>Total: <?= number_format($prix['total'], 2) ?> TND</strong>
    </div>
</td>
